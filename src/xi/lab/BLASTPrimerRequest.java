...
public class BLASTPrimerRequest {

	public List<String> makeRequest(String primerLeftInput, String primerRightInput) throws IOException{
		...
		test.addFormField("PRIMER_LEFT_INPUT", primerLeftInput);
		test.addFormField("PRIMER_RIGHT_INPUT", primerRightInput);
